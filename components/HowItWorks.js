                ...
                <Section >
                    <article className="section__acticle">
                        ...
                        <div>
                            ...
                            <p className="article__p">
                                Solo te llevará 60 segundos personalizar
                                tu perfil y comenzar a compartir lo que hacés.
                            </p>
                        </div>
                    </article>
                    ...
                    <article className="section__acticle">
                        ...
                        <div>
                            ...
                            <p className="article__p">
                                Contale a tu comunidad sobre Cafecito y tus objetivos, publicalo
                                en redes sociales así más personas podrán ver tu perfil.
                            </p>
                        </div>
                    </article>
                </Section>
