  ...
  return (
    <Nav className="navbar">
      ...
      <ul className="navbar__ul">
        <li className="navbar__li"><a href="/">Explorar</a></li>
        <li className="navbar__li"><a className="login" href="/">Ingresar</a></li>
      </ul>
    </Nav>
  )
}
